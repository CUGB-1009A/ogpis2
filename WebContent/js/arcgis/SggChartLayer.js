dojo.provide("myDojo.SggChartLayer");
dojo.require("dojox.gfx");
dojo.require("esri.geometry");
dojo.require("dojo.Stateful");

dojo.declare("myDojo.SggChartLayer", esri.layers.GraphicsLayer, {
    divid: null,
    ...
    _draw: function(graphic, redraw, zoomFlag) {
        ...
        console.log(99);
        console.log(graphic instanceof myDojo.SggPieChart);
        if (graphic instanceof myDojo.SggPieChart) {
            //if (!zoomFlag) {
        	console.log(100);
    ...
    _drawChart: function(piegraphic, zoomFlag) {
        ...
        if (zoomFlag) {
        	console.log(piegraphic.parentDiv);
//        	this.divid="#map";
