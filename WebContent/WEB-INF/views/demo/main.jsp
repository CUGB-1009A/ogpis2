...
<script type="text/javascript"
	src="<%=path %>/resource/easyui-1.5/jquery.easyui.min.js"></script>
<script type="text/javascript">
</script>
</head>
<body>
	<div class="easyui-layout" style="width: 100%; height: 800px;">
		...
		<div region="west" split="true" title="Navigator" style="width: 20%;">
			<div class="easyui-accordion" style="height: 100%;">
				...
				<div title="模块二" iconCls="icon-reload" selected="true"
					style="padding: 10px;" class="easyui-accordion" fit="true"
					border="false">
		...
		<div id="content" region="center" title="Language"
			style="padding: 5px; width: 80%"></div>
