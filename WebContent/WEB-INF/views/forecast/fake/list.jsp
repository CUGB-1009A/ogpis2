...
<body class="easyui-layout">
	<div class="easyui-panel" title="未完成预测" style="width:100%;height:100%;padding:10px;background:#fafafa;"data-options="closable:false,collapsible:false,minimizable:false,maximizable:false">  
		...
		<div style="text-align:center;padding-top:10px">
			...
			<a id="btn" href="javascript:createRecord()" class="easyui-linkbutton" ><i class="fa fa-file-excel-o" style="margin-right:3px"></i>打开</a>
			<a id="btn" href="javascript:createRecord()" class="easyui-linkbutton" ><i class="fa fa-minus" style="margin-right:3px"></i>删除</a>
		</div> 
	</div>
</body>
</html>