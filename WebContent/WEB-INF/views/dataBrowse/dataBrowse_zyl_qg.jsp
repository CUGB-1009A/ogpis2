...
<body>
	<div id="tt_zyl_dq" class="easyui-tabs" data-option="fit:true">   
	    <div title="年度各盆地油气资源量" style="display:none;">   
		        ...
		        <div class="easyui-layout" style="width:100%;height:900px;">   
		            ...
		            <div data-options="region:'center'">
		            	<div id="zyl11" style="width:100%;height:100%">
							<script>
								insertReport('AF_zyl_qg_01', 'Border=single,3D; Ruler=Horz; Rebar=Print,Property,Font; print=11, 216')
							</script>
						</div>
		            </div>   
		        </div>   
	    ...
	    <div title="年度各省区油气资源量" style="display:none;">   
	        <div data-options="region:'center'">   
		        <div class="easyui-layout" style="width:100%;height:900px;">   
		            <div data-options="region:'north',split:true" style="height:80px">
		            	<div style="float:left;">
		            ...
		            <div data-options="region:'center'">
		            	<div id="zyl11" style="width:100%;height:100%">
							<script>
								insertReport('AF_zyl_qg_02', 'Border=single,3D; Ruler=Horz; Rebar=Print,Property,Font; print=11, 216')
							</script>
						</div>
		            </div>   
		        </div>   
