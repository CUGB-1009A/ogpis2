package com.ogpis.base.common.hibernate3;
...
import com.ogpis.base.common.util.MyBeanUtils;
...
public abstract class HibernateSimpleDao {
	...
	protected Pagination findByGroup(Finder finder, String selectSql,
			int pageNo, int pageSize) {
		return findByTotalCount(finder, pageNo, pageSize,
				countQueryResultByGroup(finder, selectSql));
	}
	...
	protected int countQueryResultByGroup(Finder finder, String selectSql) {
		Query query = getSession().createQuery(
				finder.getRowCountTotalHql(selectSql));
		setParamsToQuery(finder, query);
		return ((Number) query.iterate().next()).intValue();
	}

	@SuppressWarnings("unchecked")
	private Pagination findByTotalCount(Finder finder, int pageNo,
