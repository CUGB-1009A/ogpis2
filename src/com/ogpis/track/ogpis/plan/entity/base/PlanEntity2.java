 ...
 */
@MappedSuperclass
public class PlanEntity2 extends BaseEntity {
	...
	@Deprecated
	@OneToMany(fetch = FetchType.LAZY, cascade = { CascadeType.ALL }, mappedBy = "plan")
	protected List<IndexManagement2> index;
	...
	@Deprecated
	public List<IndexManagement2> getIndex() {
		return index;
	}
	@Deprecated
	public void setIndex(List<IndexManagement2> index) {
		this.index = index;
	}
	...
	@OneToMany(mappedBy = "plan",fetch = FetchType.LAZY,targetEntity=Plan_Index2.class)
	private List<Plan_Index2> plan_indexs;


	/**
	 * @return the plan_indexs
	 */
	public List<Plan_Index2> getPlan_indexs() {
		return plan_indexs;
	}
	 ...
	 */
	public void setPlan_indexs(List<Plan_Index2> plan_indexs) {
