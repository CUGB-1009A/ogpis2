...
@Repository
public class PlanDaoImpl2 extends BaseDaoImpl<Plan2, String>
		implements PlanDao2 {

	@Override
	protected Class<Plan2> getEntityClass() {
	...
	public IPageList<Plan2> getPlans(boolean isManager,int pageNo, int pageSize, String type, String condition) {
        ...
        else//普通用户查看已发布规划
        {
        	...
        	List<Plan2> items = this.queryByHql(hql,null, first, pageSize);
	...
	public List<Plan2> findAll(boolean isManager, String type, String condition) {
        ...
        else//普通用户查看已发布规划
        {
        	...
        	List<Plan2> items = this.queryByHql(hql,null);
		return items;
	}
